...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                .requestMatchers("/profil/deleteUser").authenticated()  // Accès à la suppression uniquement pour les utilisateurs authentifiés
                .anyRequest().permitAll()  // Les autres pages restent publiques
            )
            .formLogin(form -> form
                .loginPage("/login")
                .permitAll()  // Page de connexion accessible à tous
            )
    ...
    public UserDetailsService userDetailsService(DataSource dataSource) {
        ...
        // Requête pour récupérer les informations d'utilisateur (pseudo, mot de passe, administrateur)
